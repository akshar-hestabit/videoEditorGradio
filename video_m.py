...
class VideoEditParams(BaseModel):
    ...
    cut_position: Optional[float] = None  # Added for middle cuts
...
def preliminary_keyword_check(prompt: str) -> bool:
    ...
    editing_keywords = [
        ...
        "video1", "video2", "seconds", "minutes", "start", "end", "middle", "center", "beginning", "last"
    ]
    ...
    examples = [
        {
            ...
            "output": '{"operation": "cut_and_replace", "cut_duration": 5.0, "replace_duration": 3.0, "cut_location": "start", "replace_location": "end", "cut_position": null}'
        },
        {
            "prompt": "Join video1 and video2",
            "output": '{"operation": "join", "cut_duration": 0.0, "replace_duration": 0.0, "cut_location": "start", "replace_location": "start", "cut_position": null}'
        },
        {
            "prompt": "Trim the last 4 seconds off video2 and substitute with the first 4 seconds of video1",
            "output": '{"operation": "cut_and_replace", "cut_duration": 4.0, "replace_duration": 4.0, "cut_location": "end", "replace_location": "start", "cut_position": null}'
        },
        {
            "prompt": "Put the first 5 seconds of video1 before video2",
            "output": '{"operation": "join", "cut_duration": 5.0, "replace_duration": 0.0, "cut_location": "start", "replace_location": "start", "cut_position": null}'
        },
        {
            "prompt": "Take off 2 seconds from video1 from middle and replace with beginning 2 seconds of video2",
            "output": '{"operation": "cut_and_replace", "cut_duration": 2.0, "replace_duration": 2.0, "cut_location": "middle", "replace_location": "start", "cut_position": null}'
        },
        {
            "prompt": "Remove 3 seconds from the middle of video1 and insert first 3 seconds of video2",
            "output": '{"operation": "cut_and_replace", "cut_duration": 3.0, "replace_duration": 3.0, "cut_location": "middle", "replace_location": "start", "cut_position": null}'
        },
        {
            "prompt": "Cut 3 seconds from video1 and insert the middle 3 seconds of video2",
            "output": '{"operation": "cut_and_replace", "cut_duration": 3.0, "replace_duration": 3.0, "cut_location": "start", "replace_location": "middle", "cut_position": null}'
        },
        {
            "prompt": "Cut 3 seconds from the middle of video1 and replace with 3 seconds from the middle of video2",
            "output": '{"operation": "cut_and_replace", "cut_duration": 3.0, "replace_duration": 3.0, "cut_location": "middle", "replace_location": "middle", "cut_position": null}'
        },
        {
            "prompt": "Cut 4 seconds from video1 and replace with the middle 4 seconds of video2",
            "output": '{"operation": "cut_and_replace", "cut_duration": 4.0, "replace_duration": 4.0, "cut_location": "start", "replace_location": "middle", "cut_position": null}'
        },
        {
            "prompt": "Remove 5 seconds from the end of video1 and insert the middle 5 seconds of video2",
            "output": '{"operation": "cut_and_replace", "cut_duration": 5.0, "replace_duration": 5.0, "cut_location": "end", "replace_location": "middle", "cut_position": null}'
        },
        {
            "prompt": "Cut 2 seconds from the start of video1 and replace with 2 seconds from the middle of video2",
            "output": '{"operation": "cut_and_replace", "cut_duration": 2.0, "replace_duration": 2.0, "cut_location": "start", "replace_location": "middle", "cut_position": null}'
        }
    ]
...
{operation: str, cut_duration: float, replace_duration: float|null, cut_location: str, replace_location: str, cut_position: float|null}.
...
- For 'middle' cuts in video1, set cut_location to 'middle' and cut_position to null if no specific time is provided.
- If the user specifies taking a segment from the 'middle' of video2, set replace_location to 'middle'.
- The cut_location specifies where to cut from video1 ('start', 'middle', 'end').
- The replace_location specifies where to take the segment from video2 ('start', 'middle', 'end').
...
def parse_prompt_simple(prompt: str) -> VideoEditParams:
    ...
    cut_position = None  # Default to None, will be set to midpoint in processing if needed
    print(f"[parse_prompt_simple] Cut location: {cut_location}, Replace location: {replace_location}, Cut position: {cut_position}")
...
def generate_confirmation_message(params: VideoEditParams) -> str:
    ...
    if params.replace_location == "start":
        replace_part = f"first {replace_duration} seconds"
    elif params.replace_location == "end":
        replace_part = f"last {replace_duration} seconds"
    else:  # middle
        replace_part = f"{replace_duration} seconds from the middle"

    if params.cut_location == "start":
        message = f"I will replace the first {params.cut_duration} seconds of Video 1 with the {replace_part} from Video 2."
    elif params.cut_location == "end":
        message = f"I will replace the last {params.cut_duration} seconds of Video 1 with the {replace_part} from Video 2."
    else:  # middle
        message = f"I will replace {params.cut_duration} seconds from the middle of Video 1 with the {replace_part} from Video 2."
    print(f"[generate_confirmation_message] Generated message: {message}")
    return message
